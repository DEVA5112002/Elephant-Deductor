...
interpreter = tf.lite.Interpreter(model_path="D:/elephant/human-elephant-conflict-mitigation-system-main/2-elephant-detection-with-tensorflow-lite\coco_ssd_mobilenetdetect_2.tflite")
